...
function SourceTable() {
  ...
  // ── Multi-channel table: number + name on one line ──
  if (scenario.sourceType === 'multi_channel') {
    return (
      <div className="border-t border-gray-100">
        {/* Search & Filters */}
        <div className="px-4 pt-2.5 pb-2 flex items-center gap-2">
        ...
        <div className="mx-4 border border-gray-200 rounded-lg overflow-hidden">
          ...
          <div className="grid grid-cols-[32px_1fr] gap-0 bg-gray-50 border-b border-gray-200">
            ...
            <div className="flex items-center py-2 px-3">
              <span className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider">Номер</span>
            </div>
          </div>
  ...
  // ── Generic table for departments / call centers ──
